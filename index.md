...
* Database and Data Administration
  * MS SQL (2008 – 2014)
  * Firebird (2.5)
* Basic Linux Administration (GUI and CLI)
  * Ubuntu
  * Busybox
* Customer Service
  * Technical
...
Prior to my roles on support teams I worked in Retail for some years, the majority of which was spent in customer-facing roles. During this time I’ve gained a great deal of patience and a positive attitude when interacting with both internal and external clients (in my technical roles I have provided internal support alongside the other members of my team); I’ve been mentioned by name in a number of client feedback communications and have been requested as a point of contact by several clients.
...
#### RITEQ Ltd. _(bought by Ceridian)_| **Application Support Consultant** | July ’16 – July ’18:  
